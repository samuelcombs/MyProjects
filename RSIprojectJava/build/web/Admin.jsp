    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="admin">
                ...
                <h2>Hello <c:out value='${user.firstName}'/>, Welcome to the Admin SQLGateway</h2>
                <p>Enter an SQL statement and click the Execute button.</p>

                <p><b>SQL statement:</b></p>
                <form action="<c:url value='RSI' />" method="post">
                    <input type="hidden" value="sqlGateway" name="action">
                    <textarea id="sqlStatement" name="sqlStatement" cols="60" rows="8" style="padding: 6px">${sqlStatement}</textarea>
                    <br>
                    <input type="submit" value="Execute" class="button" style="margin-top:5px">
                </form>
                <div>
                    <div style="padding:4px">
                    <input type="button" value="Clear" class="button" id="resetButton">
                    <input type="button" value="Get all HR" class="button" id="allHR">
                    <input type="button" value="Get all Admins" class="button" id="allAdmin">
                    <input type="button" value="Delete from HR or Admin" class="button" id="deleteFromHR">
                    <input type="button" value="Add New HR or Admin" class="button" id="addNewHR">
                    <input type="button" value="Insert New Skill" class="button" id="addNewSkill">
                    </div>
                    <div style="padding:4px">
                    <input type="button" value="Insert New Department" class="button" id="addNewArea">
                    <input type="button" value="Insert New Location" class="button" id="addNewLocation">
                    <input type="button" value="Delete Skill" class="button" id="deleteSkill">
                    <input type="button" value="Delete Department" class="button" id="deleteArea">
                    <input type="button" value="Delete Location" class="button" id="deleteLocation">
                    </div>
                </div>
                <p><b>SQL result:</b></p>
                ${sqlResult}
            </div>
            <script src="JS/SqlStatements.js"></script>
        </div>
